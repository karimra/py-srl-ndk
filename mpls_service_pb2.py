...
_MPLSROUTEKEYPB.fields_by_name['top_label'].message_type = sdk__common__pb2._MPLSLABEL
...
_MPLSROUTEADDRESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_MPLSROUTEDELETEREQUEST.fields_by_name['routes'].message_type = _MPLSROUTEKEYPB
_MPLSROUTEDELETERESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
