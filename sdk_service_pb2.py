...
_AGENTREGISTRATIONRESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_KEEPALIVERESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_APPIDRESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_NOTIFICATIONREGISTERREQUEST.fields_by_name['op'].enum_type = _NOTIFICATIONREGISTERREQUEST_OPERATION
_NOTIFICATIONREGISTERREQUEST.fields_by_name['intf'].message_type = interface__service__pb2._INTERFACESUBSCRIPTIONREQUEST
_NOTIFICATIONREGISTERREQUEST.fields_by_name['nw_inst'].message_type = networkinstance__service__pb2._NETWORKINSTANCESUBSCRIPTIONREQUEST
_NOTIFICATIONREGISTERREQUEST.fields_by_name['lldp_neighbor'].message_type = lldp__service__pb2._LLDPNEIGHBORSUBSCRIPTIONREQUEST
_NOTIFICATIONREGISTERREQUEST.fields_by_name['config'].message_type = config__service__pb2._CONFIGSUBSCRIPTIONREQUEST
_NOTIFICATIONREGISTERREQUEST.fields_by_name['bfd_session'].message_type = bfd__service__pb2._BFDSESSIONSUBSCRIPTIONREQUEST
_NOTIFICATIONREGISTERREQUEST.fields_by_name['route'].message_type = route__service__pb2._IPROUTESUBSCRIPTIONREQUEST
_NOTIFICATIONREGISTERREQUEST.fields_by_name['appid'].message_type = appid__service__pb2._APPIDENTSUBSCRIPTIONREQUEST
...
_NOTIFICATIONREGISTERRESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_NOTIFICATIONQUERYRESPONSE.fields_by_name['subscriptions'].message_type = _NOTIFICATIONQUERYSUBSCRIPTION
_NOTIFICATIONQUERYRESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_NOTIFICATION.fields_by_name['intf'].message_type = interface__service__pb2._INTERFACENOTIFICATION
_NOTIFICATION.fields_by_name['nw_inst'].message_type = networkinstance__service__pb2._NETWORKINSTANCENOTIFICATION
_NOTIFICATION.fields_by_name['lldp_neighbor'].message_type = lldp__service__pb2._LLDPNEIGHBORNOTIFICATION
_NOTIFICATION.fields_by_name['config'].message_type = config__service__pb2._CONFIGNOTIFICATION
_NOTIFICATION.fields_by_name['bfd_session'].message_type = bfd__service__pb2._BFDSESSIONNOTIFICATION
_NOTIFICATION.fields_by_name['route'].message_type = route__service__pb2._IPROUTENOTIFICATION
_NOTIFICATION.fields_by_name['appid'].message_type = appid__service__pb2._APPIDENTNOTIFICATION
