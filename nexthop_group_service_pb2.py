...
_NEXTHOPGROUPDELETERESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_NEXTHOPGROUPREQUEST.fields_by_name['group_info'].message_type = _NEXTHOPGROUPINFO
_NEXTHOPGROUPRESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_MPLSNEXTHOP.fields_by_name['ip_nexthop'].message_type = sdk__common__pb2._IPADDRESSPB
_MPLSNEXTHOP.fields_by_name['label_stack'].message_type = sdk__common__pb2._MPLSLABEL
...
_NEXTHOP.fields_by_name['ip_nexthop'].message_type = sdk__common__pb2._IPADDRESSPB
...
NextHopGroupDeleteRequest = _reflection.GeneratedProtocolMessageType('NextHopGroupDeleteRequest', (_message.Message,), {
  ...
  '__module__' : 'nexthop_group_service_pb2'
