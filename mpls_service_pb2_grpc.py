...
class SdkMgrMplsRouteServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MplsRouteAddOrUpdate = channel.unary_unary(
                ...
                request_serializer=mpls__service__pb2.MplsRouteAddRequest.SerializeToString,
                response_deserializer=mpls__service__pb2.MplsRouteAddResponse.FromString,
                )
        self.MplsRouteDelete = channel.unary_unary(
                '/srlinux.sdk.SdkMgrMplsRouteService/MplsRouteDelete',
                request_serializer=mpls__service__pb2.MplsRouteDeleteRequest.SerializeToString,
                response_deserializer=mpls__service__pb2.MplsRouteDeleteResponse.FromString,
                )
...
def add_SdkMgrMplsRouteServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MplsRouteAddOrUpdate': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mpls__service__pb2.MplsRouteAddRequest.FromString,
                    response_serializer=mpls__service__pb2.MplsRouteAddResponse.SerializeToString,
            ),
            'MplsRouteDelete': grpc.unary_unary_rpc_method_handler(
                    servicer.MplsRouteDelete,
                    request_deserializer=mpls__service__pb2.MplsRouteDeleteRequest.FromString,
                    response_serializer=mpls__service__pb2.MplsRouteDeleteResponse.SerializeToString,
            ),
...
class SdkMgrMplsRouteService(object):
    ...
    def MplsRouteAddOrUpdate(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrMplsRouteService/MplsRouteAddOrUpdate',
            mpls__service__pb2.MplsRouteAddRequest.SerializeToString,
            mpls__service__pb2.MplsRouteAddResponse.FromString,
    ...
    def MplsRouteDelete(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrMplsRouteService/MplsRouteDelete',
            mpls__service__pb2.MplsRouteDeleteRequest.SerializeToString,
            mpls__service__pb2.MplsRouteDeleteResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
