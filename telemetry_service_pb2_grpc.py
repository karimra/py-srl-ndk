...
class SdkMgrTelemetryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TelemetryAddOrUpdate = channel.unary_unary(
                ...
                request_serializer=telemetry__service__pb2.TelemetryUpdateRequest.SerializeToString,
                response_deserializer=telemetry__service__pb2.TelemetryUpdateResponse.FromString,
                )
        self.TelemetryDelete = channel.unary_unary(
                '/srlinux.sdk.SdkMgrTelemetryService/TelemetryDelete',
                request_serializer=telemetry__service__pb2.TelemetryDeleteRequest.SerializeToString,
                response_deserializer=telemetry__service__pb2.TelemetryDeleteResponse.FromString,
                )
...
def add_SdkMgrTelemetryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TelemetryAddOrUpdate': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=telemetry__service__pb2.TelemetryUpdateRequest.FromString,
                    response_serializer=telemetry__service__pb2.TelemetryUpdateResponse.SerializeToString,
            ),
            'TelemetryDelete': grpc.unary_unary_rpc_method_handler(
                    servicer.TelemetryDelete,
                    request_deserializer=telemetry__service__pb2.TelemetryDeleteRequest.FromString,
                    response_serializer=telemetry__service__pb2.TelemetryDeleteResponse.SerializeToString,
            ),
    }
...
class SdkMgrTelemetryService(object):
    ...
    def TelemetryAddOrUpdate(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrTelemetryService/TelemetryAddOrUpdate',
            telemetry__service__pb2.TelemetryUpdateRequest.SerializeToString,
            telemetry__service__pb2.TelemetryUpdateResponse.FromString,
    ...
    def TelemetryDelete(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrTelemetryService/TelemetryDelete',
            telemetry__service__pb2.TelemetryDeleteRequest.SerializeToString,
            telemetry__service__pb2.TelemetryDeleteResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
