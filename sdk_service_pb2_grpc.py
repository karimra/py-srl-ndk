...
import sdk_service_pb2 as sdk__service__pb2
...
class SdkMgrServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AgentRegister = channel.unary_unary(
                ...
                request_serializer=sdk__service__pb2.AgentRegistrationRequest.SerializeToString,
                response_deserializer=sdk__service__pb2.AgentRegistrationResponse.FromString,
                )
        ...
        self.NotificationRegister = channel.unary_unary(
                ...
                request_serializer=sdk__service__pb2.NotificationRegisterRequest.SerializeToString,
                response_deserializer=sdk__service__pb2.NotificationRegisterResponse.FromString,
                )
        self.NotificationQuery = channel.unary_unary(
                '/srlinux.sdk.SdkMgrService/NotificationQuery',
                request_serializer=sdk__service__pb2.NotificationQueryRequest.SerializeToString,
                response_deserializer=sdk__service__pb2.NotificationQueryResponse.FromString,
                )
        self.KeepAlive = channel.unary_unary(
                '/srlinux.sdk.SdkMgrService/KeepAlive',
                request_serializer=sdk__service__pb2.KeepAliveRequest.SerializeToString,
                response_deserializer=sdk__service__pb2.KeepAliveResponse.FromString,
                )
        self.GetAppId = channel.unary_unary(
                '/srlinux.sdk.SdkMgrService/GetAppId',
                request_serializer=sdk__service__pb2.AppIdRequest.SerializeToString,
                response_deserializer=sdk__service__pb2.AppIdResponse.FromString,
                )
...
def add_SdkMgrServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AgentRegister': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=sdk__service__pb2.AgentRegistrationRequest.FromString,
                    response_serializer=sdk__service__pb2.AgentRegistrationResponse.SerializeToString,
            ),
            ...
            'NotificationRegister': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=sdk__service__pb2.NotificationRegisterRequest.FromString,
                    response_serializer=sdk__service__pb2.NotificationRegisterResponse.SerializeToString,
            ),
            'NotificationQuery': grpc.unary_unary_rpc_method_handler(
                    servicer.NotificationQuery,
                    request_deserializer=sdk__service__pb2.NotificationQueryRequest.FromString,
                    response_serializer=sdk__service__pb2.NotificationQueryResponse.SerializeToString,
            ),
            'KeepAlive': grpc.unary_unary_rpc_method_handler(
                    servicer.KeepAlive,
                    request_deserializer=sdk__service__pb2.KeepAliveRequest.FromString,
                    response_serializer=sdk__service__pb2.KeepAliveResponse.SerializeToString,
            ),
            'GetAppId': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAppId,
                    request_deserializer=sdk__service__pb2.AppIdRequest.FromString,
                    response_serializer=sdk__service__pb2.AppIdResponse.SerializeToString,
            ),
    }
...
class SdkMgrService(object):
    ...
    def AgentRegister(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrService/AgentRegister',
            sdk__service__pb2.AgentRegistrationRequest.SerializeToString,
            sdk__service__pb2.AgentRegistrationResponse.FromString,
    ...
    def NotificationRegister(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrService/NotificationRegister',
            sdk__service__pb2.NotificationRegisterRequest.SerializeToString,
            sdk__service__pb2.NotificationRegisterResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def NotificationQuery(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrService/NotificationQuery',
            sdk__service__pb2.NotificationQueryRequest.SerializeToString,
            sdk__service__pb2.NotificationQueryResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def KeepAlive(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrService/KeepAlive',
            sdk__service__pb2.KeepAliveRequest.SerializeToString,
            sdk__service__pb2.KeepAliveResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetAppId(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/srlinux.sdk.SdkMgrService/GetAppId',
            sdk__service__pb2.AppIdRequest.SerializeToString,
            sdk__service__pb2.AppIdResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    *
    ...
    def __init__(self, channel):
        ...
        self.NotificationStream = channel.unary_stream(
                ...
                request_serializer=sdk__service__pb2.NotificationStreamRequest.SerializeToString,
                response_deserializer=sdk__service__pb2.NotificationStreamResponse.FromString,
                )
...
def add_SdkNotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'NotificationStream': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=sdk__service__pb2.NotificationStreamRequest.FromString,
                    response_serializer=sdk__service__pb2.NotificationStreamResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
    ...
    *
    ...
    def NotificationStream(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/srlinux.sdk.SdkNotificationService/NotificationStream',
            sdk__service__pb2.NotificationStreamRequest.SerializeToString,
            sdk__service__pb2.NotificationStreamResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
