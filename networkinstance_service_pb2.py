...
_NETWORKINSTANCEDATA.fields_by_name['loopback_addr'].message_type = sdk__common__pb2._IPADDRPREFLENPB
...
_NETWORKINSTANCENOTIFICATION.fields_by_name['op'].enum_type = sdk__common__pb2._SDKMGROPERATION
...
NetworkInstanceSubscriptionRequest = _reflection.GeneratedProtocolMessageType('NetworkInstanceSubscriptionRequest', (_message.Message,), {
  ...
  '__module__' : 'networkinstance_service_pb2'
