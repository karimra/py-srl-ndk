...
_ROUTEKEYPB.fields_by_name['ip_prefix'].message_type = sdk__common__pb2._IPADDRPREFLENPB
_ROUTEPB.fields_by_name['nexthop'].message_type = nexthop__group__service__pb2._NEXTHOP
...
_ROUTEADDRESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_ROUTEDELETEREQUEST.fields_by_name['routes'].message_type = _ROUTEKEYPB
_ROUTEDELETERESPONSE.fields_by_name['status'].enum_type = sdk__common__pb2._SDKMGRSTATUS
_IPROUTESUBSCRIPTIONREQUEST.fields_by_name['key'].message_type = _ROUTEKEYPB
_IPROUTENOTIFICATION.fields_by_name['op'].enum_type = sdk__common__pb2._SDKMGROPERATION
...
_SDKMGRROUTESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=2,
    containing_service=None,
    input_type=sdk__common__pb2._SYNCREQUEST,
    output_type=sdk__common__pb2._SYNCRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
